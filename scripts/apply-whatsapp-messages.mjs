/**
 * Aplica migración whatsapp_messages vía Postgres pooler (necesita DB password).
 *
 * Uso:
 *   SUPABASE_DB_PASSWORD='tu-password' node scripts/apply-whatsapp-messages.mjs
 *
...
const sqlPath = resolve(process.cwd(), "supabase/migrations/20260904_whatsapp_messages.sql");
