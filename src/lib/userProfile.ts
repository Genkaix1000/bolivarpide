...
export const CHARACTER_PRESETS: CharacterPreset[] = [
  {
    id: "char-cat-michi",
    name: "Michi",
    description: "Gatito carismático con cascabel dorado",
    foodTag: "🐱 Mascota",
    defaultColorId: "mint",
  },
  {
    id: "char-lucas",
    name: "Lucas",
    description: "Pelo oscuro rizado y sonrisa amistosa",
    foodTag: "✨ Personaje",
  ...
  },
  {
    id: "char-sofia",
    name: "Sofía",
    description: "Corte bob castaño con vincha",
    foodTag: "✨ Personaje",
    defaultColorId: "navy",
  },
  {
    id: "char-mateo",
    name: "Mateo",
    description: "Gorra urbana y hoodie casual",
    foodTag: "✨ Personaje",
  ...
  },
  {
    id: "char-valen",
    name: "Valentina",
    description: "Rodete alto y aros dorados",
    foodTag: "✨ Personaje",
  ...
  },
  {
    id: "char-joaquin",
    name: "Joaquín",
    description: "Lentes redondos y estilo moderno",
    foodTag: "✨ Personaje",
  ...
  },
  {
    id: "char-camila",
    name: "Camila",
    description: "Cabello ondeado y sonrisa radiante",
    foodTag: "✨ Personaje",
  ...
  },
  {
    id: "char-firulais",
    name: "Firulais",
    description: "Perrito alegre con orejitas caídas",
    foodTag: "🐶 Mascota",
    defaultColorId: "sky",
  },
];
