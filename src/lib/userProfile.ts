...
export const AVATAR_FRAMES: AvatarFramePreset[] = [
  ...
  {
    id: "frame-gold-vip",
    name: "Aura Dorada VIP",
    description: "Corona y aro dorado brillante por detrás del personaje",
    rarity: "oro",
    borderClass: "ring-4 ring-amber-400 shadow-[0_0_18px_rgba(251,191,36,0.55)]",
    icon: "workspace_premium",
  },
  {
    id: "frame-ruby-cherry",
    name: "Aura Carmesí Royale",
    description: "Borde carmesí radiante con destellos",
    rarity: "rubi",
  ...
  {
    id: "frame-cyber-neon",
    name: "Aura Neón Cyber",
    description: "Gradiente cian violeta resplandeciente",
    rarity: "diamante",
    borderClass: "ring-4 ring-cyan-400 shadow-[0_0_22px_rgba(34,211,238,0.6)]",
    icon: "auto_awesome",
  },
  {
    id: "frame-flame-gourmet",
    name: "Llamas Parrilleras",
    description: "Aura de fuego para amantes de la buena mesa",
    rarity: "oro",
    borderClass: "ring-4 ring-orange-500 shadow-[0_0_18px_rgba(249,115,22,0.6)]",
    icon: "local_fire_department",
  },
  {
    id: "frame-emerald-leaf",
    name: "Corona Laurel",
    description: "Corona vegetal para catadores expertos",
    rarity: "plata",
    borderClass: "ring-4 ring-emerald-400 shadow-[0_0_16px_rgba(52,211,153,0.5)]",
    icon: "eco",
  },
];
...
export const DEFAULT_USER_PROFILE: UserProfile = {
  ...
  unlockedFrameIds: ["none", "frame-gold-vip", "frame-ruby-cherry", "frame-flame-gourmet", "frame-emerald-leaf"],
};
