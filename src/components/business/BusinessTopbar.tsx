        ...
        <div className="mx-auto flex h-[64px] w-full max-w-[1280px] items-center gap-3 px-4 md:gap-5 md:px-8">
          ...
          <div className="relative z-50 flex shrink-0 items-center gap-2.5 md:gap-3">
            <button
              ...
              onClick={openSearch}
              aria-label="Buscar"
              className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full text-stone-500 transition-colors hover:bg-[#ede4d9] md:hidden dark:text-stone-400 dark:hover:bg-[#2a2623]"
            >
